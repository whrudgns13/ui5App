		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#fiorilocaltest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorilocaltest-display": {
								"semanticObject": "fiorilocaltest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorilocaltest",
									"url": sap.ui.require.toUrl("fiorilocaltest")
								}
							}
						}
					}
